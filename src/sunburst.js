...
export default Kapsule({
  ...
  update: function(state) {
    ...
    // Show/hide labels
    const showHideAngularLabelsTransition = allSlices.select('.angular-label')
    ...
    const radialTextTransformTransition =
      computeRadialLabels && allSlices.selectAll('g.radial-label').selectAll('text')
        .transition(transition);
    radialTextTransformTransition && radialTextTransformTransition.textTween(d => () => labelMetaCache.get(d).label);
